  ...
  return (
    <section className='relative w-full mx-auto h-screen'>
        <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl max-auto flex flex-row items-start gap-5`}>
          ...
          <div>
            <h1 className={`${styles.heroHeadText} text-white`}>Hi, I`m  <span className='text-[#915eff]'>Atirh Gael </span></h1>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
               A full stack web <br className='sm:block hidden' /> and mobile developer
            </p>
          </div>
